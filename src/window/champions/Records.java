...
public class Records {
     ...
     * </p>
     *
     * @param difficulty - game difficult specifies the table to clear
     */
     ...
     * </p>
     *
     * @param difficulty - game difficulty specifies the table for adding
     * @param name       - name of player
     * @param time       - time player took for win
     */
    public void addRecord(GameDifficulty difficulty, String name, int time) {
        ...
        if (list.size() > Const.MaxRecordsNumber()) {
            list.remove(Const.MaxRecordsNumber().intValue());
        }
     ...
     * </p>
     *
     * @param difficulty - game difficulty specifies table to get
     ...
     * </p>
     *
     * @param difficulty - specifies table to add new record
     * @param time       - time user took for a win
