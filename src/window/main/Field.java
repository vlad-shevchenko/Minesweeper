...
public class Field extends JPanel {
    ...
    private final MouseHandler mouseListener = new MouseHandler();
     ...
     * </p>
     *
     * @param fWidth  - number of cells along horizontal line
     * @param fHeight - number of cells along vertical line
     * @param bombs   - number of bombs on the field
     * @author Vlad
     */
    ...
    private void incAround(int x, int y) {
        ...
        for (Cell[] aSubArray : subArray) {
            for (int j = 0; j < subArray[0].length; ++j) {
                if (aSubArray[j] != null) {
                    aSubArray[j].incBombsCount();
                }
            }
        }
    }
    ...
    private void bombActivated() {
        for (Cell[] cell : cells) {
            for (int j = 0; j < cells[0].length; j++) {
                if (cell[j].isBomb()) {
                    cell[j].setState(CellState.Bomb_inactive);
                }
            }
        }
    }
    ...
    private class MouseHandler extends MouseAdapter {
         ...
         * </p>
         *
         * @param cords      of cell clicked
         * @param sourceCell - cell that was clicked
         * @author Vlad
         */
         ...
         * </p>
         *
         * @param sourceCell - cell was clicked
         * @author Vlad
         */
